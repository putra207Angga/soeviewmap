...
class AuthDao {
  ...
  static Future<Response<UserProfile>> getProfile() async {
    return await ApiService.to.getRequest<UserProfile>(
      '/api/me',
      decoder: (data) {
        print('AuthDao: getProfile decoder received data of type ${data.runtimeType}: $data');
